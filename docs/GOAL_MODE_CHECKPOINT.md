...
Last updated: 2026-06-24 unsafe validation sweep result-adoption-status guard
...
- Latest full tests: `python -m unittest discover -s tests` PASS, `603` tests.
