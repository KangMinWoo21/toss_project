...
Last updated: 2026-06-24 unsafe candidate decision recommendation guard
...
- Latest full tests: `python -m unittest discover -s tests` PASS, `584` tests.
